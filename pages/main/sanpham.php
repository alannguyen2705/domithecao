<h1 style="text-align: center; color: darkolivegreen;">Product details</h1>
<?php
...
<div class="wrapper_chitiet">
	...
	<form method="POST" action="pages/main/themgiohang.php?idsanpham=<?php echo $row_chitiet['id_sanpham'] ?>">
		<div class="chitiet_sanpham">
			...
			<p><input onclick="myFunction()" class="themgiohang" name="themgiohang" type="submit" value="Add Cart"></p>
		</div>
	</form>
